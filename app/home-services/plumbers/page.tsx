...
export default function PlumbersLeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans overflow-x-hidden">
      <main>
        ...
        {/* ==================== 2. PLUMBING EMERGENCIES NEVER WAIT (Updated with Animation Video) ==================== */}
        ...
        {/* ==================== 3. NO MORE WAITING — JUST A FULL SCHEDULE ==================== */}
        ...
        {/* ==================== 4. HOW WE KEEP YOUR PLUMBING LEADS FLOWING NON-STOP ==================== */}
        <section className="bg-gray-50/50 py-20 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                We handle the entire lead routing pipeline so your technicians can focus on fixing pipes, installing fixtures, and expanding your local service area.
              </p>
            </div>
        ...
        <section className="bg-blue-50/80 py-20 border-y border-blue-100">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Scale your plumbing business with predictable, recurring service leads that convert into high-value customer lifetime value.
              </p>
            </div>
