  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans overflow-x-hidden">
      <main>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                Tap Into a Flood of Medicare Insurance Leads!
              </h1>
              
              <p className="text-sm lg:text-base text-gray-600 leading-relaxed">
                Stop wasting your marketing budget on ineffective leads and low-intent traffic. AffCall connects Medicare insurance agents and brokers directly with seniors and beneficiaries actively searching for medical insurance plans — without wasting time or ad budget.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                The medicare insurance market is one of the most lucrative and rewarding sectors in the insurance industry. With tens of thousands of seniors entering Medicare every day, finding a steady stream of incoming prospects is key to growing your practice and staying competitive in the market.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                Our platform delivers exclusive, high-intent live phone calls and web leads instantly to your business. We handle the heavy lifting so you can focus on consulting seniors, navigating enrollment periods, and scaling your agency to new heights.
              </p>
            </div>
        ...
        <section className="bg-gray-50/50 py-20 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Reaching a lucrative milestone of 10,000 seniors ages 65 and older, providing a stream of health coverage for hospital stays, medicare parts, prescription drug coverages, and annual election periods. Seniors are searching for expert guidance in navigating options, and your agency should be positioned right where they look when they are ready to sign up for plans.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                From senior navigating Medicare for the first time or switching from old plans to better fit plans for the fall open enrollment, these consumers are actively searching for guidance on Medicare Advantage (Part C) or Medicare Supplement (Medigap) insurance options. When individuals search for medical coverage, they need immediate assistance — and they choose the agency that answers first.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                This is where we come in. We take precise targeting and performance-driven campaigns to deliver exclusive, pre-screened medicare leads that are ready to enroll. Skip the guesswork of traditional advertising. Focus on helping seniors find the right insurance options while we handle the complicated setup of generating high-intent traffic for your practice.
              </p>
            </div>
        ...
        {/* ==================== 3. SENIOR-FOCUSED LEADS THAT ACTUALLY CONVERT! ==================== */}
        <section className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            
            <div className="space-y-6">
              <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">
                Senior-Focused Leads That Actually Convert!
              </h2>
              
              <div className="space-y-4 text-sm text-gray-600">
                <div className="flex items-start space-x-3">
                  <span className="text-orange-500 font-bold mt-1">✔</span>
                  <p><strong>Protect your marketing budget:</strong> Invest in high-quality traffic that produces real revenue. We filter out low-intent clicks and send only genuine seniors looking for Medicare coverage options.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-orange-500 font-bold mt-1">✔</span>
                ...
                <div className="flex items-start space-x-3">
                  <span className="text-orange-500 font-bold mt-1">✔</span>
                  <p><strong>Scale predictably:</strong> Grow your Medicare portfolio month after month with a steady influx of high-intent seniors looking to enroll or upgrade their healthcare coverage without straining your marketing budget.</p>
                </div>
              </div>
        ...
        {/* ==================== 4. HOW WE CONNECT YOU WITH MEDICARE PROSPECTS? ==================== */}
        <section className="bg-gray-50/50 py-20 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">
                How We Connect You With Medicare Prospects?
              </h2>
              
              <p className="text-sm text-gray-600 leading-relaxed">
                We combine the power of high-converting web forms and direct telephone calls to connect you with prospective health policy buyers. By utilizing targeted digital campaigns, search engine positioning, and optimized keyword targeting, we capture individuals actively seeking Medicare Advantage and Supplement plans.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                <strong>INBOUND CALLS:</strong> When a user calls via our managed tracking numbers, our intelligent platform routes the call instantly to your agents. No waiting periods, no unverified cold forms — just live conversations with high-intent seniors looking for Medicare coverage right now.
              </p>

              <p className="text-sm text-gray-600 leading-relaxed">
                We handle the entire lead routing pipeline so your team can focus on consulting health plans, explaining benefits, and expanding your portfolio.
              </p>
            </div>
        ...
        <section className="bg-blue-50/80 py-20 border-y border-blue-100">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Our approach is simple: We bring you high-intent seniors looking for immediate Medicare guidance. With real-time delivery and strict compliance filters, you can connect directly with consumers actively comparing marketplace plans.
              </p>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Scale your health agency with predictable, recurring Medicare leads that convert into high-value customer lifetime value.
              </p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Scale your enrollment pipeline seamlessly with steady, consistent inbound calls tailored to your target geographic states and Medicare plan offerings.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                {openFaq === 0 && (
                  <div className="px-6 pb-4 text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-3">
                    AffCall provides exclusive, high-intent live phone call leads and web leads across health insurance lines, including Medicare Advantage (Part C), Medicare Supplement (Medigap), and Prescription Drug Plans (Part D).
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                {openFaq === 2 && (
                  <div className="px-6 pb-4 text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-3">
                    We use rigorous filtering, intent verification, and compliance protocols to block spam callers, ensuring that only qualified seniors reach your licensed health insurance agents.
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                {openFaq === 3 && (
                  <div className="px-6 pb-4 text-sm text-gray-600 leading-relaxed border-t border-gray-100 pt-3">
                    Fill out the lead form at the top of the page with your agency's information or email our support staff directly to configure your target Medicare campaign parameters.
                  </div>
                )}
              </div>
